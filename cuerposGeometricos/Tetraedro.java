...
public class Tetraedro extends CuerposGeometricos {
	...
	public void PedirTetraedro(Scanner entrada) {
	...
	public void CalcularTetraedro(int exponente1, int exponente2) {
		    area = Math.pow(a, exponente1) * Math.sqrt(3);
			volumen = (Math.sqrt(2) * Math.pow(a, exponente2)) / 12;
			h = (a * Math.sqrt(6)) / 3;
	}
	...
	@Override
	public void forma() {
		System.out.println("El tetraedro tiene forma triangular");
	}
	@Override
	public void color() {
		System.out.println("El tetraedro es de color rosa");
	}

	public Tetraedro(int exponente1, int exponente2, double volumen, double area, double h, double a) {
